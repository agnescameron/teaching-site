...
All servers operate through ports. We mentioned these last week, 
  *cool ports you should know*  
Remember last week, where we were looking at 

**firewalls 🔥**  
Firewalls are a safety measure used to prevent malicious traffic from coming into a computer's ports. They protect computers from things like

The simples kind of firewall is a packet filter
...
To check this works, we can go to port 8080 and check it out! Try editing the HTML to create a different page! 

**more complex: handling http endpoints**

In order to show different pages depending on the url in our address bar, we want to use something called 'routing'. For this, we'll want the 'express' middleware I mentioned earlier. Now, every time I go to the mian 
