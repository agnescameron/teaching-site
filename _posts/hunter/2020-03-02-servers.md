...
Create a new file called 'index.js', and open it using a text editor.
...
To create a very simple server, paste the following in index.js:
...
For this part, we all need to do three things

1. connect to the local wifi network. Look in the list of WiFi networks, and select one called 'fake tattoo'. This is being hosted by a small router called a Piratebox. It won't connect to the wider internet, but it'll let us talk to each other very easily without worrying about proxies.
